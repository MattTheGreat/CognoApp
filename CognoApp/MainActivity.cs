...
namespace CognoApp
{
	//[Activity(Label = "CognoDroid", MainLauncher = true, Icon = "@mipmap/icon")]
	[Activity(Label = "CognoApp", MainLauncher = true, Icon = "@drawable/icon", ScreenOrientation = ScreenOrientation.Portrait)]
